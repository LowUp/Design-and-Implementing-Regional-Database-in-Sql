...
VALUES ('user67', 'roM', 'Ri', 'asdef@krukru.com', '27-AUG-1996');

INSERT INTO subscription VAlUES (seq_SubscriptionPrimaryID.NEXTVAL, CONCAT('SUB', seq_SubNumber.NEXTVAL), TO_CHAR(SYSDATE, 'DD-MON-RR'),'24-JAN-2020', 1,1);
